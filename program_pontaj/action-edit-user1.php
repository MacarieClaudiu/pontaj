...
$email = $record['email'];
$password = "";
$lastname_err = $firstname_err = $email_err = $password_err = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($lastname_err) && empty($firstname_err) && empty($email_err) && empty($password_err)){
            ...
            $sql = "UPDATE users SET lastname = '$lastname', firstname = '$firstname', email ='$email' , password = '$password' WHERE id_user = '$id'";
...
?>
    ...
    <div class="wrapper">
        ...
        <form action="index.php?action=edit-user1&id=<?php echo $id;?>" method="post">
